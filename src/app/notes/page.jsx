								...
								{editingNote?.id === note.id ? (
									<CardContent className="pt-4 sm:pt-6">
										<form onSubmit={handleUpdateNote} className="space-y-4">
											...
											<div>
												<Label htmlFor="editContent" className={`text-sm sm:text-base ${session?.user?.darkMode ? 'text-white' : 'text-gray-700'}`}>
													Content *
												</Label>
												<Textarea
													id="editContent"
											...
											<div className="flex flex-col sm:flex-row gap-3 sm:gap-2 pt-4">
												...
												<Button type="button" variant="outline" className="border-gray-300 hover:bg-gray-50 w-full sm:w-auto" onClick={cancelEditing}>
													Cancel
												</Button>
											</div>
										</form>
